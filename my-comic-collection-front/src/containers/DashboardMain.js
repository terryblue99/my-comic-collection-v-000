  ...
  const sortElement = [
    <>
      ...
      <select id='Select-sort'
        ...
        <option value='Grade Low to High'>Grade Low to High</option>
        <option value='Grade High to Low'>Grade High to Low</option>
        ...
        <option value='Date Shipped Old to New'>Date Shipped Old to New</option>
        <option value='Date Shipped New to Old'>Date Shipped New to Old</option>
